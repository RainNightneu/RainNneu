    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(int i=0;i<enterprise.getOrganizationDirectory().getOrganizationList().size();i++)
        {
            ...
            if(organizationJComboBox.getSelectedItem().equals(enterprise.getOrganizationDirectory().getOrganizationList().get(i)))
            {
                ...
                for(int k=0;k<4;k++)
                {
                    if(roleJComboBox.getSelectedItem().equals("Sales Representative"))
                    {
                        role=new SalesRole();
                    }
                    if(roleJComboBox.getSelectedItem().equals("Project Manager"))
                    {
                        role=new PMRole();
                    }
                    if(roleJComboBox.getSelectedItem().equals("Translator"))
                    {
                        role=new TransRole();
                    }
                }
