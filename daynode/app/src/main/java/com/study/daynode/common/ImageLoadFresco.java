...
public class ImageLoadFresco {
   ...
   * 如 失败图 重试图 圆角或圆形
   */
  private void setViewPerformance(LoadImageFrescoBuilder frescoBuilder,
      GenericDraweeHierarchyBuilder builderM, PipelineDraweeControllerBuilder builderC) {
  ...
  public static class LoadImageFrescoBuilder {
     ...
     * 构造器的构造方法 传入必要参数
     */
    public LoadImageFrescoBuilder(Context mContext, SimpleDraweeView mSimpleDraweeView,
        String mUrl) {
    ...
    public LoadImageFrescoBuilder setBitmapDataSubscriber(
    ...
    public LoadImageFrescoBuilder setActualImageScaleType(
        ScalingUtils.ScaleType mActualImageScaleType) {
