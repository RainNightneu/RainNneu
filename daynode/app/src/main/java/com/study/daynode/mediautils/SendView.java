package com.study.daynode.mediautils;
...
public class SendView extends RelativeLayout {
    ...
    private void init(Context context){
        ...
        RelativeLayout layout = (RelativeLayout) LayoutInflater.from(context).inflate(
            com.study.daynode.R.layout.widget_view_send_btn,null,false);
        layout.setLayoutParams(params);
        backLayout = (RelativeLayout) layout.findViewById(com.study.daynode.R.id.return_layout);
        selectLayout = (RelativeLayout) layout.findViewById(com.study.daynode.R.id.select_layout);
        addView(layout);
        setVisibility(GONE);
    }
