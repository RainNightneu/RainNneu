function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"red","bg_over":"#EFEFEF","bg_out":"#FFCC00"}
};
...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = '<table id="__calendarTable" width="100%" border="0" cellpadding="3" cellspacing="0.5" align="center">';
	_cs[_cs.length] = ' <tr>';
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;margin:0px;padding:0px;width:200px;height:210px;">');
document.writeln('<iframe name="__calendarIframe" id="__calendarIframe" width="100%" height="100%" scrolling="no" frameborder="0" style="border:0px;margin:0px;padding:0px;"><\/iframe>');
